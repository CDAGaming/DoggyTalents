...
public class DoggyBeamRenderer<T extends Entity> extends EntityRenderer<T> {
    ...
    public void render(T entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
        ...
        this.itemRenderer.renderStatic(new ItemStack(Items.SNOWBALL), ItemDisplayContext.GROUND, packedLightIn, OverlayTexture.NO_OVERLAY, matrixStackIn, bufferIn, entityIn.level, entityIn.getId());
